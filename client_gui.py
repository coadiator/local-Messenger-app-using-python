...
ap.add_argument("-hh", "--host", required=True,
    help="Provide Host ip shown in server GUI")
...
def connect_to_server(name):
    ...
    try:
        ...
        print("Hii_1") #do not block the main thread :)
...
def getChatMessage(msg):
    ...
    send_mssage_to_server(bytes(msg, 'utf-8'))
