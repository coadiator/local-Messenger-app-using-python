...
def send_receive_client_message(client_connection, client_ip_addr):
    ...
    client_name  = client_connection.recv(8192)
    msg = b"welcome " + client_name + b".Use 'exit' to quit"
    ...
    while True:
        ...
        msg1 = cipher.decrypt(data)
        if not msg1: break
        if msg1 == b"exit": break
        ...
        for c in clients:
            if c != client_connection:
                c.send(sending_client_name + b"->" + client_msg)
